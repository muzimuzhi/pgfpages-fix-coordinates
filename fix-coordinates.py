...
parser = argparse.ArgumentParser(description='Fix links in PDF generated by LaTeX package pgfpages')
parser.add_argument('raw', help='raw pdf file')
parser.add_argument('nup', help='nup pdf file using pgfpages')
# parser.add_argument('--options', help='pgfpages settings')  # only support "2 in 1"
parser.add_argument('--output', help='output pdf', default='fixed.pdf')

args = parser.parse_args()
fname_reader = [args.raw, args.nup]
